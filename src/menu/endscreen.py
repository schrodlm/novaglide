...
class EndScreenMenu(Menu):
    def __init__(self, game, match_stats):
        ...
        self.new_elos = Elo.calculate_elo(self.old_elo[0], self.old_elo[1], self.goals[0] > self.goals[1])
...
# Display the winner
            ...
            for i, header in enumerate(headers):
                ...
                x_pos = [first_column_x, second_column_x, third_column_x, fourth_column_x][i]
            ...
            for entity, stats in self.stats.items():
                ...
                #Elos
                elos_text = stat_font.render(f"{self.old_elo[idx]} + ({self.new_elos[idx]-self.old_elo[idx]})", True, (255, 255, 255))
